...
public class AFApplication extends Application {
    ...
    private static final String AF_DEV_KEY = "omzu3WUpGTHaQRf5yNksoR";
    ...
    public static void setInstallData(Map<String, String> conversionData){
        if(sessionCount == 0){
            ...
            InstallConversionData += ifF + install_type + media_source + install_time + click_time + is_first_launch;
            sessionCount++;
        }
